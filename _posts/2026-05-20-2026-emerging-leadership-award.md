---
title: "2026 Emerging Leadership Award"
date: 2026-05-20
layout: post
image: meeting.jpg
---
...
<h2 class="text-primary">
    <i class="fa-solid fa-award"></i> OHBM Australia's 2026 EL Award
</h2>
...
1. Applicants must be within ten years of completing their doctoral degree (based on the date of the letter of completion, not conferral) as of 30 Sep 2026.
...
All application materials must be compiled into a single PDF and submitted via email to **<a href="mailto:{{ site.email }}">{{ site.email }}</a>** with Emerging Leadership Award in subject line by<span style="color: red;"> the deadline of **Monday, 28 September 2026**</span>.
